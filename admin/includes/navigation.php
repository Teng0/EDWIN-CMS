...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">MIS ADMIN</a>
    </div>
    <!-- Top Menu Items -->
...
<!--            </li>-->
            ...
            <li>
                ...
                <ul id="demo2" class="collapse">
                    <li>
                        <a href="posts.php?source=post_all">View All Posts</a>
                    </li>
                    <li>
                        <a href="posts.php?source=post_add">Add Post</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Project <i class="fa fa-fw fa-caret-down"></i></a>
